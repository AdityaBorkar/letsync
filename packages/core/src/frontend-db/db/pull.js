...
function pull(props, superProps) {
    return __awaiter(this, void 0, void 0, function () {
        var apiBaseUrl, database, metadata;
        return __generator(this, function (_a) {
            apiBaseUrl = superProps.apiBaseUrl, database = superProps.database, metadata = superProps.metadata;
            // if (WRITE_LOCK) {
