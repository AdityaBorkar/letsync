// TODO - Support extensions after preview release
...
// import type { Letsync_PubSub_Frontend, Config } from '@letsync/core';
...
//  * @param {Config} params.config - The configuration for Letsync.
